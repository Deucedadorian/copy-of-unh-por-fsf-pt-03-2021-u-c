...
const addition = (x, y, z) => {
  ...
  return array.reduce((currentValue, b) => currentValue + b, 0);
};
// What do you expect to be logged in the console?
// 6
...
function customReduce(...array) {
  ...
  return array.reverse().reduce((currentValue, item) => {
...
// What do you expect to be logged in the console?
// 6
console.log(customReduce( 1, 2, 3 ));

// What do you expect to be logged in the console?
// 110
console.log(customReduce(1, 2, 3, 4, 100));
